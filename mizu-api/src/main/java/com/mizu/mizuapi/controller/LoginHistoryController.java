...
public class LoginHistoryController extends GenericCRUDController<LoginHistoryEntity, LoginHistoryDTO> {
    ...
    public LoginHistoryController(GenericCRUDRepository<LoginHistoryEntity, LoginHistoryDTO> repository, GenericMapper<LoginHistoryEntity, LoginHistoryDTO> mapper) {
